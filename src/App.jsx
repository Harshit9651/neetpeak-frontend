...
import ProtectedOrderConfirmation from "./pages/CheckOutPage/ProtectedOrderconferm";
import CallBookingConfirmation from "./pages/CheckOutPage/CallConfermation";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/mentorship-call-checkout"
          element={<MentorshipCallCheckout />}
        />
        <Route path="/productDetail/:id" element={<ProductDetails />} />
        <Route
          path="/order-confirmation"
          element={<ProtectedOrderConfirmation />}
        />
            <Route
          path="/call-booking-confirmation"
          element={<CallBookingConfirmation />}
        />
      </Routes>
      <Footer />
    </>
